...
public class ArrayTools {
   ...
   public static void main(String args[]) {
      ...
      log.info("%s", ArrayTools.concat(r));
   }
   ...
   public static String concat(String[] b, int pos, int length, String separator) {
      StringBuilder sb = new StringBuilder();
      if (b.length > 0) {
         sb.append(b[pos]);
      }
   ...
   public static String concatInt(List<Integer> list) {
      StringBuilder sb = new StringBuilder();
      for (int i : list) {
         sb.append(", ").append(i);
      }
