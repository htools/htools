...
import io.github.repir.tools.Content.BytesOut;
 ...
 * <p/>
 * To use: create a new class that extends StructuredFile. For the fields,
 * create class variables of any type that extends one of the nested classes of
 * {@link StructuredDataStream.Element}. Override {@link #initStructure()} to
 * add the fields to the StructuredFile structure, in that order.
 * <p/>
 * @author jeroen
 */
public abstract class StructuredFile extends StructuredDataStream {
    ...
    * for sorted implementations of StructuredFile, allowing them to cache &
