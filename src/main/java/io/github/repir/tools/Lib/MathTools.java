...
public enum MathTools {
    ...
    public static double sumDouble(Collection<Double> x) {
        double sum = 0;
        for (Double i : x) {
            sum += i;
        }
    ...
    public static double avgDouble(Collection<Double> x) {
        if (x.size() == 0) {
            return Double.NaN;
        }
        double total = 0;
    ...
    public static double avgInt(Collection<Integer> x) {
        if (x.size() == 0) {
            return Double.NaN;
        }
        int total = 0;
     ...
     * @return
     */
    public static double avgInteger(Collection<Integer>... collections) {
        double total = 0;
        int count = 0;
    ...
    public static double varianceInteger(Collection<Integer> x, double avg) {
        if (x.size() == 0) {
            return Double.NaN;
        }
        double dev = 0;
    ...
    public static double standardDeviationInteger(Collection<Integer> x) {
        double avg = avgInteger(x);
        double variance = varianceInteger(x, avg);
        return java.lang.Math.sqrt(variance);
    }

    public static double varianceDouble(Collection<Double> x, double avg) {
        if (x.size() == 0) {
            return Double.NaN;
        }
        double dev = 0;
    ...
    public static double standardDeviationDouble(Collection<Double> x) {
        double avg = avgDouble(x);
        double variance = varianceDouble(x, avg);
        return java.lang.Math.sqrt(variance);
    }
