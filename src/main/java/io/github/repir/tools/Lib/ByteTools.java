...
public class ByteTools {
  ...
  /**
   * Compares the byte contents in two byte arrays, until the first \0 byte, therefore
   * suitable to compare \0 terminated Strings. Similar to Hadoop's WritableComparator.
   */
