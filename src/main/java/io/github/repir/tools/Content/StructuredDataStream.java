...
public abstract class StructuredDataStream extends StructuredStream {
    ...
    */
   public StructuredDataStream(StructureReader reader) {
      super(reader);
   }
    ...
    */
   public StructuredDataStream(StructureWriter writer) {
      super(writer);
   }
...
//   }
   ...
   public class IntField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addInt(label[0]);
      }
   }
   ...
   public class BoolField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addBoolean(label[0]);
      }
   }
   ...
   public class Int2Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addInt2(label[0]);
      }
   }
   ...
   public class Int3Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addInt3(label[0]);
      }
   }
   ...
   public class CIntField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addCInt(label[0]);
      }
   }
   ...
   public class DoubleField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addDouble(label[0]);
      }
   }
   ...
   public class CDoubleField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addCDouble(label[0]);
      }
   }
   ...
   public class ByteField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addByte(label[0]);
      }
   }
   ...
   public class FixedMemField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addFixedMem(label[0], length);
      }
   }
   ...
   public class MemField extends Field {
      ...
      public byte[] read() throws EOFException {
         checkRead(this);
         return value = reader.readByteBlock();
      }

      public void write(byte b[]) {
         checkWrite(this);
         if (writer != null) {
            writer.writeByteBlock(value = b);
         }
         writeDone(this);
      }
      ...
      public void skip() throws EOFException {
         checkRead(this);
         reader.skipByte();
         int length = reader.readCInt();
         reader.skip(length);
      }

      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addMem(label[0]);
      }
   }
   ...
   public class UnsignedByteField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addUnsignedByte(label[0]);
      }
   }
   ...
   public class StringField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addString(label[0]);
      }
   }
   ...
   public class String0Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addString0(label[0]);
      }
   }
   ...
   public class StringArrayField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addStringArray(label[0]);
      }
   }
   ...
   public class StringPairField extends Field {
      ...
      public Map<String, String> read() throws EOFException {
         checkRead(this);
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addStringPairMap(label[0]);
      }
   }
   ...
   public class LongArrayField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addLongArray(label[0]);
      }
   }
   ...
   public class LongCArray2Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addSquaredLongArray2(label[0]);
      }
   }
   ...
   public class LongSparse2Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addLongSparse2(label[0]);
      }
   }
   ...
   public class IntArrayField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addIntArray(label[0]);
      }
   }
   ...
   public class SquaredIntArray2Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addSquaredIntArray2(label[0]);
      }
   }
   ...
   public class CIntArray2Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addCIntArray2(label[0]);
      }
   }
   ...
   public class IntSparse2Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addIntSparse2(label[0]);
      }
   }
   ...
   public class SquaredIntArray3Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addSquaredIntArray3(label[0]);
      }
   }
   ...
   public class CIntArray3Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addCIntArray3(label[0]);
      }
   }
   ...
   public class IntSparse3Field extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addIntSparse3(label[0]);
      }
   }
   ...
   public class CIntArrayField extends Field {
      ...
      public ArrayList<Integer> readArrayList() throws EOFException {
         checkRead(this);
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addCIntArray(label[0]);
      }
   }
   ...
   public class CIntIncrField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addCIntIncr(label[0]);
      }
   }
   ...
   public class LongField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addLong(label[0]);
      }
   }
   ...
   public class CLongField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addCLong(label[0]);
      }
   }
   ...
   public class CLongArrayField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addCLongArray(label[0]);
      }
   }
   ...
   public class LongSparseField extends Field {
      ...
      public Map<Integer, Long> readMap() throws EOFException {
         checkRead(this);
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addLongSparse(label[0]);
      }
   }
   ...
   public class IntSparseField extends Field {
      ...
      public Map<Integer, Integer> readMap() throws EOFException {
         checkRead(this);
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addIntSparse(label[0]);
      }
   }
   ...
   public class DoubleSparseField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addDoubleSparse(label[0]);
      }
   }
   ...
   public class IterField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addIter(label[0]);
      }
   }
   ...
   public class LongIterField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addLongIter(label[0]);
      }
   }
   ...
   protected class IterEndField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addIterEnd((IterField) d.find(FieldType.ITEREND, label[0]));
      }
   }
   ...
   protected class LongIterEndField extends Field {
      ...
      public Field clone(StructuredStream d) {
         return ((StructuredDataStream) d).addLongIterEnd((LongIterField) d.find(FieldType.LONGITERSTART, label[0]));
      }
   }
}
