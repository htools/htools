...
public class BufferDelayedWriter implements StructureWriter {
   ...
   public void write0Str(String s) {
      if (s != null) {
         write(s.getBytes());
      }
      write((byte) 0);
   ...
   public static interface SerializeRead {
      void read(StructureReader reader) throws EOFException;
   }
   
   public static interface SerializeWrite {
      void write(StructureWriter writer);
   }
   
   public static interface Serialize extends SerializeRead, SerializeWrite {
   }
}
