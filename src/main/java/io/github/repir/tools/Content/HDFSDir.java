...
public class HDFSDir extends Path implements Dir {
   ...
   public static boolean rename(FileSystem fs, Path path, Path dest) {
      try {
   ...
   public static boolean copy(FileSystem fs, Path path, Path dest) {
   ...
   public static boolean rename(FileSystem fs, String source, String dest) {
      return rename(fs, new Path(source), new Path(dest));
   }

   public static boolean copy(FileSystem fs, String source, String dest) {
      return copy(fs, new Path(source), new Path(dest));
   }

   public static boolean delete(FileSystem fs, String filename) {
      return delete(fs, new Path(filename));
   }
