...
public class TokenizerRegex extends ExtractorProcessor {
    ...
    private TokenizerRegex(Extractor extractor, String process, String states[]) {
    ...
    public TokenProcessor setupTokenProcessor(String name, Class processorclazz) {
        //log.info("%s %s %s", name, regex, processorname);
        Constructor cons = ClassTools.getAssignableConstructor(processorclazz, TokenProcessor.class, TokenizerRegex.class, String.class);
