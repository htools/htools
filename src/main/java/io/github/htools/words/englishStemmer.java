...
public class englishStemmer extends SnowballStemmer {
   ...
   private static englishStemmer singleton;

   public static englishStemmer get() {
      if (singleton == null) {
         singleton = new englishStemmer();
      }
      return singleton;
   }

   public static englishStemmer getCached() {
      if (singleton == null || !(singleton instanceof cachedStemmer)) {
         singleton = new cachedStemmer();
      }
      return singleton;
   }

   static class cachedStemmer extends englishStemmer {
      HashMap<String, String> cache = new HashMap();

      public String stem(String term) {
          String prestemmed = cache.get(term);
         if (prestemmed == null) {
            prestemmed = super.stem(term);
            cache.put(term, prestemmed);
         }
         return prestemmed;
      }
   }
