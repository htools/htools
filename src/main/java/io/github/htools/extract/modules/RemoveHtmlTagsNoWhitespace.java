 ...
 * @author jeroen
 */
public class RemoveHtmlTagsNoWhitespace extends ExtractorProcessor {

   public static Log log = new Log(RemoveHtmlTagsNoWhitespace.class);
   public ByteRegex start = new ByteRegex("<[/!]?[A-Za-z][A-Za-z0-9]*");

   private RemoveHtmlTagsNoWhitespace(Extractor extractor, String process) {
