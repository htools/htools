...
public class StoreLiteralSection extends ExtractorProcessor {
    ...
    public void process(Content entity, ByteSearchSection section, String attribute) {
        String literal = ByteTools.toFullTrimmedString(entity.content, section.innerstart, section.innerend);
        //log.info("store literal %s", literal);
        entity.get(attribute).add(literal);
    }
}
