 ...
 * @author jeroen
 */
public class RemoveNonAlphanumericQuote extends ExtractorProcessor {

   public static Log log = new Log(RemoveNonAlphanumericQuote.class);
   boolean[] allowedCharacters = BoolTools.combineRanges(BoolTools.alphanumeric(), BoolTools.createASCIIAccept('\0', '\''));

   private RemoveNonAlphanumericQuote(Extractor extractor, String process) {
