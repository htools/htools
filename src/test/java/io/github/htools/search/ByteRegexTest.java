...
public class ByteRegexTest {
    ...
    public void testFindFirst_3args() {
        ...
        sets.add(new find(new String[]{"<top> top </top>", "top><head> head </top>"},
                new testcase("<to+p>", new ByteSearchPosition(null, 0, 5), ByteSearchPosition.notFound()),
                new testcase(".top(?=>)", new ByteSearchPosition(null, 0, 4), ByteSearchPosition.notFound()),
                new testcase("top>", ByteSearchPosition.notFound(), new ByteSearchPosition(null, 0, 4)),
                new testcase("<?top>", new ByteSearchPosition(null, 0, 5), new ByteSearchPosition(null, 0, 4)),
                new testcase(".", new ByteSearchPosition(null, 0, 1), new ByteSearchPosition(null, 0, 1)),
                new testcase("^[<t]", new ByteSearchPosition(null, 0, 1), new ByteSearchPosition(null, 0, 1))
        ));
        for (find s : sets) {
            for (testcase c : s.testcase) {
                for (int r = 0; r < s.source.length; r++) {
                    ...
                    assertEquals(io.github.htools.lib.PrintTools.sprintf("failed source '%s' pattern '%s'", s.source[r], c.regex.pattern), c.expectedResult[r], result);
                }
            }
        }
    }
    ...
    public void testFind_3args() {
        ...
        ArrayList<find> sets = new ArrayList<find>();
        sets.add(new find(new String[]{"<top> top </top>", "<top><head> head </top>"},
                new testcase("<to+p>", new ByteSearchPosition(null, 0, 5), new ByteSearchPosition(null, 0, 5)),
                new testcase("<top(?=>)", new ByteSearchPosition(null, 0, 4), new ByteSearchPosition(null, 0, 4)),
                new testcase("</top>$", new ByteSearchPosition(null, 10, 16, false), new ByteSearchPosition(null, 17, 23, false)),
                new testcase(" ", new ByteSearchPosition(null, 5, 6), new ByteSearchPosition(null, 11, 12)),
                new testcase(".", new ByteSearchPosition(null, 0, 1), new ByteSearchPosition(null, 0, 1))));
        sets.add(new find(new String[]{"a3ap.noot3=checks", "noot3=doesnt ", "aap.noot", ""},
                new testcase("na*o*t", new ByteSearchPosition(null, 5, 9), new ByteSearchPosition(null, 0, 4), new ByteSearchPosition(null, 4, 8), ByteSearchPosition.endReached()),
                new testcase("^noot", ByteSearchPosition.notFound(), new ByteSearchPosition(null, 0, 4), ByteSearchPosition.notFound(), ByteSearchPosition.endReached()),
                new testcase("\\c\\w*(\\.\\c\\w*)+\\=\\S*", new ByteSearchPosition(null, 0, 17, true), ByteSearchPosition.notFound(), ByteSearchPosition.notFound(), ByteSearchPosition.endReached()),
                new testcase("\\c\\w*(\\.\\c\\w*)+\\=\\S*$", new ByteSearchPosition(null, 0, 17, true), ByteSearchPosition.notFound(), ByteSearchPosition.notFound(), ByteSearchPosition.endReached())));
        for (find s : sets) {
            s.test();
        }
    ...
    public void testMatchPos() {
        ...
        sets.add(new find(new String[]{"<top> top </top>", "top><head> head </top>"},
                new testcase("<to+p>", new ByteSearchPosition(null, 0, 5), ByteSearchPosition.notFound()),
                new testcase("<top(?=>)", new ByteSearchPosition(null, 0, 4), ByteSearchPosition.notFound()),
                new testcase("</top>$", new ByteSearchPosition(null, 10, 16, false), new ByteSearchPosition(null, 16, 22, false)),
                new testcase(" ", new ByteSearchPosition(null, 5, 6), new ByteSearchPosition(null, 10, 11)),
                new testcase(".", new ByteSearchPosition(null, 0, 1), new ByteSearchPosition(null, 0, 1))
        ));
        for (find s : sets) {
            s.test();
    ...
    public void testLookBehind() {
        ...
        sets.add(new find(new String[]{"test d'Arc", "robert's ", "o'brien", "'s"},
                new testcase("'(?<=\\c')", new ByteSearchPosition(null, 6, 7), new ByteSearchPosition(null, 6, 7), new ByteSearchPosition(null, 1, 2), ByteSearchPosition.notFound()),
                new testcase("['\\-]\\w((?<=\\W\\w['\\-]\\w)|(?<=^\\w['\\-]\\w))", new ByteSearchPosition(null, 6, 8), ByteSearchPosition.notFound(), new ByteSearchPosition(null, 1, 3), ByteSearchPosition.notFound()),
                new testcase("'s(?<=\\c's)", ByteSearchPosition.notFound(), new ByteSearchPosition(null, 6, 8), ByteSearchPosition.notFound(), ByteSearchPosition.notFound())
        ));
        for (find s : sets) {
            s.test();
        }
    ...
    public void testOptionalEnd() {
        ...
        ArrayList<find> sets = new ArrayList<find>();
        sets.add(new find(new String[]{"test d'Arc", "robert's ", "o'brien", "'s\\n"},
                new testcase("[^\\n]+\\n?", new ByteSearchPosition(null, 0, 10, true), new ByteSearchPosition(null, 0, 9, true), new ByteSearchPosition(null, 0, 7, true), new ByteSearchPosition(null, 0, 4, true)) // appearently \n is two bytes
        ));
        for (find s : sets) {
            s.test();
        }
    ...
    public void testFindNumber() {
        ...
        sets.add(new find(new String[]{"10.0", "10.0 aap", "aap 10.0 aap", "aap 10.0e", "aap 10.0.2 a", "aap 10.0e3", "aap 10.0e-3"},
                new testcase("(^|(?<=[^\\w\\.]))\\d+\\.\\d+(e[\\-\\+]?\\d+)?($|(?=[^\\w\\.]))",
                        new ByteSearchPosition(null, 0, 4, true),
                        new ByteSearchPosition(null, 0, 4),
                        new ByteSearchPosition(null, 4, 8),
                        ByteSearchPosition.notFound(),
                        ByteSearchPosition.notFound(),
                        new ByteSearchPosition(null, 4, 10, true),
    ...
    public void testFindNumber1() {
        ...
        sets.add(new find(new String[]{"u.s.", "uu.s.", " .s."},
                new testcase("\\.((?<=^\\c\\.)|(?<=[^\\w\\.]\\c\\.))(\\c\\.)+",
                        new ByteSearchPosition(null, 1, 4, true), ByteSearchPosition.notFound(), ByteSearchPosition.notFound())
        ));
        for (find s : sets) {
            s.test();
        }
    ...
    public void testInvertedGroup() {
        ...
        sets.add(new find(new String[]{"1", "a", " ", "."},
                new testcase("[^\\w\\.]",
                        ByteSearchPosition.notFound(), ByteSearchPosition.notFound(), new ByteSearchPosition(null, 0, 1, false), ByteSearchPosition.notFound())
        ));
        for (find s : sets) {
            s.test();
        }
    ...
    public void testUngreedy() {
        ...
        sets.add(new find(new String[]{"12345678901234567890"},
                ...
                new testcase("2.*4", new ByteSearchPosition(null, 1, 14, true)) // greedy always trigger endReached
        ));
        for (find s : sets) {
            s.test();
        }
        ...
        sets.add(new find(new String[]{" <TITLE ", "<a href=> ", "<0 ", "< aap ",
            "<h0> ", "<title/>"},
                new testcase("</?[A-Za-z]\\w*?[/\\s>]",
                        new ByteSearchPosition(null, 1, 8, false), new ByteSearchPosition(null, 0, 3),
                        ByteSearchPosition.notFound(), ByteSearchPosition.notFound(),
                        new ByteSearchPosition(null, 0, 4), new ByteSearchPosition(null, 0, 7))
        ));
        for (find s : sets) {
            s.test();
        }
    ...
    public void testEscapedQuote() {
        ...
        sets.add(new find(new String[]{" '\\''", " \"\\\"\"", " ''", " \"\""},
                new testcase("\\Q",
                        new ByteSearchPosition(null, 1, 5, false),
                        new ByteSearchPosition(null, 1, 5, false),
                        new ByteSearchPosition(null, 1, 3, false),
                        new ByteSearchPosition(null, 1, 3, false)
                )));
        for (find s : sets) {
            s.test();
    ...
    public void testEscapedQuote1() {
        ...
        sets.add(new find(new String[]{" <TITLE a=''>"},
                new testcase("\\s+\\w+=\\Q",
                        new ByteSearchPosition(null, 7, 12, false)
                )));
        for (find s : sets) {
            s.test();
        }
    ...
    public void testEscapedQuote3() {
        ...
        sets.add(new find(new String[]{" <TITLE a='' b=\"\\\"\" c=\"aap\">"},
                new testcase("<\\w+(\\s+\\w+=\\Q)*/?>",
                        new ByteSearchPosition(null, 1, 28, false)
                )));
        for (find s : sets) {
            s.test();
        }
    ...
    public void testContent() {
        ...
        sets.add(new find(new String[]{" <T name=\"description\""},
                new testcase("\\sname\\s*=\\s*['\"]?(keywords|description)",
                        new ByteSearchPosition(null, 3, 21, false)
                )));
        for (find s : sets) {
            s.test();
        }
    ...
    public void testMinus() {
        ...
        sets.add(new find(new String[]{" --az-za"},
                new testcase("-[a-z]+",
                        new ByteSearchPosition(null, 2, 5, false)
                )));
        for (find s : sets) {
            s.test();
        }
        ...
        public void test() {
            for (testcase c : testcase) {
                for (int r = 0; r < source.length; r++) {
                    ...
                    assertEquals(io.github.htools.lib.PrintTools.sprintf("failed source '%s' pattern '%s'", source[r], c.regex.pattern), c.expectedResult[r], result);
                }
            }
        }
    }
        ...
        public void test() {
            for (testcase c : testcase) {
                for (int r = 0; r < source.length; r++) {
                    ...
                    assertEquals(io.github.htools.lib.PrintTools.sprintf("failed source '%s' pattern '%s'", source[r], c.regex.pattern), c.expectedResult[r], result.size());
                }
            }
        }
