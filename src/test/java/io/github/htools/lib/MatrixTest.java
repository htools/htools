...
import io.github.htools.type.Matrix;
import io.github.htools.type.SparseDoubleArray;
import io.github.htools.type.SparseDoubleMatrix;
...
public class MatrixTest {
   ...
   public void testDot1() {
      ...
      Assert.assertTrue("Matrices " + ArrayTools.toString(r1) + " and " + ArrayTools.toString(e1) + " are not the same", ArrayTools.equals(r1,e1) );
      Assert.assertTrue("Matrices " + ArrayTools.toString(r2) + " and " + ArrayTools.toString(e2) + " are not the same", ArrayTools.equals(r2,e2) );
   }
