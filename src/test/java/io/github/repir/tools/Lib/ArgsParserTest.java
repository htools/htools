...
//        parsedargs = new ArgsParser(new String[0], "[param]");
    ...
    public void testNonFatal() {
        ...
        assertEquals(parsedargs.getParameter("param").get(0), "aap");
        assertEquals(parsedargs.getParameter("opt").get(0), "noot");
    }
    ...
    public void flags1() {
        ...
        assertEquals("aap", parsedargs.getParameter("first").get(0));
        assertEquals("noot", parsedargs.getParameter("third").get(0));
        assertEquals("mies", parsedargs.getParameter("second").get(0));
    }
    ...
    public void optional2() {
        ...
        assertEquals("noot", parsedargs.getParameter("second").get(0));
        assertEquals("mies", parsedargs.getParameter("third").get(0));
    }
    ...
    public void repeated2() {
        ...
        assertEquals("aap", parsedargs.getParameter("second").get(0));
    ...
    public void booleanFlag() {
        ...
        assertEquals("true", parsedargs.getParameter("f").get(0));
        assertEquals("noot", parsedargs.getParameter("second").get(0));
        assertEquals("mies", parsedargs.getParameter("third").get(0));
    }
}
